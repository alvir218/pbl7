...
class DisciplinaLivro(models.Model):
    DisciplinaId = models.ForeignKey(Disciplina,related_name='DisciplinaLivro',on_delete=models.CASCADE)
    cod_livro = models.ForeignKey(Livros,related_name='DisciplinaLivro',on_delete=models.CASCADE)
